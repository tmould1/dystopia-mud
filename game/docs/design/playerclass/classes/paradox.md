...
**Source Files**: `src/classes/paradox.c`, `src/classes/chronomancer.h`
**Class Constant**: `CLASS_PARADOX` = 33554432 (2^25)
**Upgrades From**: Chronomancer

## Color Scheme

Paradox uses a crimson/rose palette evoking temporal danger and reality bleeding:

| Element | Code | Color | Usage |
|---------|------|-------|-------|
| Accent | `#x160` | Deep crimson (RGB 215,0,0) | Bracket arrows, decorative accents |
| Primary | `#x210` | Warm rose (RGB 255,135,135) | Class name, titles, ability highlights |
| Bracket open | `#x160>(#x210` | Crimson>(Rose | Who list open bracket |
| Bracket close | `#x210)#x160<` | Rose)Crimson< | Who list close bracket |
| Room tag | `#x210(#nParadox#x210)` | Rose parens | Room display prefix |

**Who List Titles**:

| Generation | Title | Display |
|------------|-------|---------|
| 1 | Temporal God | `#x160>(#x210Temporal God#n#x210)#x160<` |
| 2 | Time Breaker | `#x160>(#x210Time Breaker#n#x210)#x160<` |
| 3 | Paradox | `#x160>(#x210Paradox#n#x210)#x160<` |
| 4 | Anomaly | `#x160>(#x210Anomaly#n#x210)#x160<` |
| default | Glitch | `#x160>(#x210Glitch#n#x210)#x160<` |
...
**Training Cost**: `(current_level + 1) * 45` primal per level (`ability.para.train.cost_mult`)
...
|----------|-------|------------|
| Mana Cost | 100 | `ability.para.rewind.mana` |
| Flux Required | 40-110 (balanced range) | |
| Cooldown | 20 pulses | `ability.para.rewind.cd` |
| Rewind Amount | Last 5 ticks of damage (max 1500) | `ability.para.rewind.max_heal` |
| Requires | Timeline 1 | |
...
| Property | Value | Config Key |
|----------|-------|------------|
| Mana Cost | 120 | `ability.para.split.mana` |
| Flux Required | 50-100 (balanced) | |
| Duration | 3 rounds | `ability.para.split.rounds` |
| Cooldown | 30 pulses | `ability.para.split.cd` |
| Requires | Timeline 2 | |
...
| Property | Value | Config Key |
|----------|-------|------------|
| Mana Cost | 180 | `ability.para.convergence.mana` |
| Flux Cost | 50 (toward center) | `ability.para.convergence.flux` |
| Cooldown | 35 pulses | `ability.para.convergence.cd` |
| Base Damage | 500-800 | |
...
| Property | Value | Config Key |
|----------|-------|------------|
| Mana Cost | 60 | `ability.para.futurestrike.mana` |
| Flux Change | +15 | `ability.para.futurestrike.flux` |
| Cooldown | 6 pulses | `ability.para.futurestrike.cd` |
...
| Property | Value | Config Key |
|----------|-------|------------|
| Mana Cost | 100 | `ability.para.pastself.mana` |
| Flux Change | -20 | `ability.para.pastself.flux` |
| Duration | 8 ticks | `ability.para.pastself.duration` |
| Cooldown | 25 pulses | `ability.para.pastself.cd` |
...
| Property | Value | Config Key |
|----------|-------|------------|
| Mana Cost | 90 | `ability.para.timeloop.mana` |
| Flux Required | 40-110 (balanced) | |
| Duration | 3 rounds | `ability.para.timeloop.rounds` |
| Cooldown | 20 pulses | `ability.para.timeloop.cd` |
...
| Property | Value | Config Key |
|----------|-------|------------|
| Mana Cost | 120 | `ability.para.paradoxstrike.mana` |
| Flux Cost | 30 (toward center) | `ability.para.paradoxstrike.flux` |
| Cooldown | 12 pulses | `ability.para.paradoxstrike.cd` |
...
| Property | Value | Config Key |
|----------|-------|------------|
| Mana Cost | 80 | `ability.para.age.mana` |
| Flux Change | -25 | `ability.para.age.flux` |
| Duration | 10 ticks | `ability.para.age.duration` |
| Cooldown | 15 pulses | `ability.para.age.cd` |
...
| Property | Value | Config Key |
|----------|-------|------------|
| Mana Cost | 160 | `ability.para.collapse.mana` |
| Flux Required | < 30 OR > 120 (extreme) | |
| Flux Change | Moves 40 toward center | `ability.para.collapse.flux_restore` |
| Cooldown | 30 pulses | `ability.para.collapse.cd` |
...
| Property | Value | Config Key |
|----------|-------|------------|
| Mana Cost | 250 | `ability.para.eternity.mana` |
| Flux Cost | All (resets to 75) | |
| Duration | 6 ticks | `ability.para.eternity.duration` |
| Cooldown | 60 pulses | `ability.para.eternity.cd` |
| Requires | Entropy 3 | |
...
|-------|------|-----------|
| infinity staff | 33560 | Wield |
| mobius ring | 33561 | Finger |
| hourglass pendant | 33562 | Neck |
| timeweave robes | 33563 | Torso |
| crown of moments | 33564 | Head |
| paradox leggings | 33565 | Legs |
| boots of ages | 33566 | Feet |
| temporal gauntlets | 33567 | Hands |
| chrono-bracers | 33568 | Arms |
| cloak of eternities | 33569 | About Body |
| loop belt | 33570 | Waist |
| timeline bracer | 33571 | Wrist |
| mask of the void | 33572 | Face |

**Mastery Item**: Vnum 33575
...
|--------|-------|-------------|
| Flux Extreme | +5 per point from center (max +375) | `combat.damcap.para.extreme_mult` (default: 5) |
| Past Self | +100 flat | `combat.damcap.para.pastself` (default: 100) |
| Time Loop | +150 flat | `combat.damcap.para.timeloop` (default: 150) |
...
|-------|----------|---------|
| class | ch->class | CLASS_PARADOX bit (33554432) |
