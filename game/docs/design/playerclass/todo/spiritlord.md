...
| SL_TRAIN_DOMINION (11) | Dominion | 4 | Spirit command | Command, Possess, Spirit Army, Soul Storm |
...
| Level | Ability | Unlock |
|-------|---------|--------|
| 1 | `command` | Command nearby spirits to attack |
...
### Command - Spirit Assault (Dominion)

Commands nearby spirits in the area to attack a target.

| Property | Value | Config Key |
|----------|-------|------------|
| Mana Cost | 60 | `ability.sl.command.mana_cost` |
| Tether Change | +12 | `ability.sl.command.tether_change` |
| Cooldown | 6 pulses | `ability.sl.command.cooldown` |
| Base Damage | 200-400 | `ability.sl.command.base_damage` |
...
- Spirit Bolt auto-fires every round for free
...
| (reserved) | ch->pcdata->stats[0-4] | |
| ascensions_used | ch->pcdata->stats[5] | Times Ascension used (tracking) |
