                          ...
                          int cx, int cy, int radius )
{
    ...
    while ( head < tail )
    {
        ...
        for ( dir = 0; dir < 4; dir++ )
        {
            ...
            switch ( dir )
            {
                case DIR_NORTH: map->exit_n[cur_x][cur_y] = exit_type; break;
                case DIR_EAST:  map->exit_e[cur_x][cur_y] = exit_type; break;
                case DIR_SOUTH: map->exit_s[cur_x][cur_y] = exit_type; break;
                case DIR_WEST:  map->exit_w[cur_x][cur_y] = exit_type; break;
            }
            ...
            if ( visited[new_x][new_y] )
            {
                ...
                if ( map->rooms[new_x][new_y] != to_room )
                {
                    ...
                    switch ( dir )
                    {
                        case DIR_NORTH: map->exit_n[cur_x][cur_y] = 3; break;
                        case DIR_EAST:  map->exit_e[cur_x][cur_y] = 3; break;
                        case DIR_SOUTH: map->exit_s[cur_x][cur_y] = 3; break;
                        case DIR_WEST:  map->exit_w[cur_x][cur_y] = 3; break;
                    }
                }
                continue;
            }
