...
void do_oset( CHAR_DATA *ch, char *argument ) {
	...
	if ( !str_cmp( arg2, "type" ) ) {
		...
		if ( !str_cmp( arg3, "light" ) )
			...
			obj->item_type = 26;
		else if ( !str_cmp( arg3, "instrument" ) )
	...
	for ( d = descriptor_list; d != NULL; d = d->next ) {
		...
		if ( d->character != NULL && can_see( ch, d->character ) ) {
			...
			case CON_GET_OLD_PASSWORD:
				st = "#3Get Old Passwd#n ";
				break;
			case CON_CONFIRM_NEW_NAME:
				st = "#3 Confirm Name #n ";
				break;
			case CON_GET_NEW_PASSWORD:
				st = "#3Get New Passwd#n ";
				break;
			case CON_CONFIRM_NEW_PASSWORD:
				st = "#3Confirm Passwd#n ";
				break;
			case CON_GET_NEW_SEX:
				st = "#3  Get New Sex #n ";
				break;
			case CON_GET_NEW_VT102:
				st = "#3 Picking VT102#n ";
				break;
...
void do_copyover( CHAR_DATA *ch, char *argument ) {
	...
	if ( !fp ) {
		...
		merc_logf( "Could not write to copyover file: %s", COPYOVER_FILE );
