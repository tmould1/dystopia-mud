...
void fwrite_obj( CHAR_DATA *ch, OBJ_DATA *obj, FILE *fp, int iNest ) {
	...
	if ( ( obj->chobj != NULL && ( !IS_NPC( obj->chobj ) && obj->chobj->pcdata->obj_vnum != 0 ) ) || obj->item_type == ITEM_KEY )
		return;
