...
REM ============================================================================
echo [2/6] Scanning source directories...
...
REM ============================================================================
echo [3/6] Generating Makefile (Linux GCC)...
...
echo 	$^(CC^) -c $^(C_FLAGS^) $^< -o $@
echo.
echo # SQLite amalgamation uses special flags ^(suppress warnings, disable threading^)
echo $^(OBJ_DIR^)/db/sqlite3.o: $^(DB_DIR^)/sqlite3.c
...
REM ============================================================================
REM Step 4: Generate Visual Studio Solution (Windows MSVC)
REM ============================================================================
echo [4/6] Generating dystopia.sln (Visual Studio Solution)...
...
REM ============================================================================
REM Step 5: Generate Visual Studio Project
REM ============================================================================
echo [5/6] Generating dystopia.vcxproj (Visual Studio Project)...
...
REM Temporarily disable delayed expansion so ! characters are output literally
...
REM Add source files (with special handling for sqlite3.c)
for %%d in (%SUBDIRS%) do (
    for %%f in (..\src\%%d\*.c) do (
        if exist "%%f" (
            for %%n in (%%~nf) do (
...
REM ============================================================================
REM Step 6: Generate Visual Studio Project Filters
REM ============================================================================
echo [6/6] Generating dystopia.vcxproj.filters (Folder Structure)...
